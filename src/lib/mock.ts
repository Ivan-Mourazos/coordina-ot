...
// Los de Diseño Gráfico van detrás y con `seccion`, que es de donde sale su
// lista de trabajo (ver lib/secciones.ts). Los de OT no la llevan: son la
...
const SPECS: Spec[] = [
  // ── Alberto ──
  { codigo: "AR.26.05501", cliente: "MAHOU", prioridad: 3, entrega: "2026-07-01", solicitud: "2026-06-12", plan: "2026-06-27", accent: "verde", croquis: true,
  ...
  // ── Adrián ──
  { codigo: "AR.26.05537", cliente: "Restaurante O Forno", prioridad: 2, entrega: "2026-07-03", solicitud: "2026-06-13", accent: "verde", croquis: false,
    ofs: [["TOLDO", "Toldo brazo invisible 3,5m", 1, "adrian", "en_curso"]] },
  { codigo: "AR.26.05541", cliente: "Hostal A Ponte", prioridad: 1, entrega: "2026-07-09", solicitud: "2026-06-19", accent: "ninguno", croquis: true,
  ...
  // ── Bandeja (sin asignar) ──
  { codigo: "AR.26.05555", cliente: "Remolcar", prioridad: 3, entrega: "2026-07-04", solicitud: "2026-06-20", plan: "2026-06-24", accent: "verde", croquis: true,
    ofs: [["REMOLQUE", "Lona remolque basculante", 1, null], ["REMOLQUE", "Lona remolque tándem", 1, null]] },
  { codigo: "AR.26.05559", cliente: "Bar Central", prioridad: 2, entrega: "2026-07-11", solicitud: "2026-06-21", accent: "ninguno", croquis: false,
    ofs: [["TOLDO", "Toldo barra exterior", 1, null]] },
  { codigo: "AR.26.05562", cliente: "Cafetería Goz", prioridad: 1, entrega: "2026-07-14", solicitud: "2026-06-22", accent: "azul", croquis: false,
    ofs: [["TOLDO", "Punto recto 4m", 1, null], ["SUMINISTRO", "Tela acrílica naranja", 1, null]] },
  { codigo: "AR.26.05566", cliente: "Concello de Melide", prioridad: 2, entrega: "2026-07-12", solicitud: "2026-06-22", accent: "rojo", croquis: true,
    ofs: [["LONA", "Lonas mercado", 10, null], ["CARPA", "Carpa plegable 3×3", 2, null], ["SUMINISTRO", "Contrapesos", 8, null]] },
  { codigo: "AR.26.05570", cliente: "Hotel Pazo Real", prioridad: 1, entrega: "2026-07-16", solicitud: "2026-06-24", accent: "ninguno", croquis: false,
    ofs: [["TAPIZADO", "Fundas asientos piscina", 14, null]] },
  { codigo: "AR.26.05573", cliente: "Náutica Vigo", prioridad: 3, entrega: "2026-07-05", solicitud: "2026-06-23", accent: "verde", croquis: true,
    ofs: [["REPARACION", "Reparación bimini", 1, null], ["TAPIZADO", "Cojín bañera", 2, null]] },
  { codigo: "AR.26.05577", cliente: "MAHOU", prioridad: 2, entrega: "2026-07-13", solicitud: "2026-06-25", accent: "ninguno", croquis: false,
    ofs: [["LONA", "Lona camión 13,6m", 1, null]] },
  { codigo: "AR.26.05581", cliente: "Talleres Lema", prioridad: 1, entrega: "2026-07-18", solicitud: "2026-06-26", accent: "azul", croquis: false,
    ofs: [["SUMINISTRO", "Suministro lona PVC rollo", 2, null]] },

  // ── Historial (finalizados: todas las OF aprobadas) ──
  { codigo: "AR.26.05490", cliente: "Camping As Sinas", prioridad: 2, entrega: "2026-06-26", solicitud: "2026-06-02", plan: "2026-06-18", accent: "verde", croquis: true,
    ofs: [["CARPA", "Carpa restaurante 8×15", 1, "jaime", "aprobada", "alberto"], ["LONA", "Faldones laterales", 6, "jaime", "aprobada", "alberto"]] },
  { codigo: "AR.26.05487", cliente: "Pazo de Lestrove", prioridad: 3, entrega: "2026-06-25", solicitud: "2026-06-01", plan: "2026-06-16", accent: "rojo", croquis: false,
    ofs: [["TOLDO", "Toldo cofre jardín 5×3,5", 1, "tamara", "aprobada", "ivan"]] },
  { codigo: "AR.26.05495", cliente: "Bar O Recuncho", prioridad: 1, entrega: "2026-06-28", solicitud: "2026-06-05", plan: "2026-06-20", accent: "azul", croquis: false,
  ...
  { codigo: "AR.26.05590", cliente: "Camping Costa Verde", prioridad: 2, entrega: "2026-07-20", solicitud: "2026-06-28", situacion: "pendiente", accent: "ninguno", croquis: false,
    ofs: [["TOLDO", "Toldo terraza (sin definir)", 1, null]] },
  { codigo: "AR.26.05593", cliente: "Náutica Vigo", prioridad: 3, entrega: "2026-07-15", solicitud: "2026-06-29", situacion: "pendiente", accent: "ninguno", croquis: false,
    ofs: [["TAPIZADO", "Tapizado (pendiente medidas)", 1, null]] },
  { codigo: "AR.26.05596", cliente: "Concello de Arzúa", prioridad: 1, entrega: "2026-07-22", solicitud: "2026-06-30", situacion: "pendiente", accent: "ninguno", croquis: false,
    ofs: [["LONA", "Lonas festas (sin procesar)", 4, null]] },
];

const OBSERVACIONES: Record<string, string> = {
  "AR.26.05530": "Falta cota de la guía y referencia de la tela. Revisar medidas antes de Producción.",
  "AR.26.05548": "Faltan las medidas de anclaje de la nave. Revisar in situ antes de replantear.",
};
